function theta = SlitheringMod(snakeData,sm)
    ...
    % Generate the joint waves - Slithering
    for i=1:snakeData.num_modules
        ...
        % taper the gait
        theta(i) = theta(i)*(snakeData.num_modules - taper*abs(i-19))/snakeData.num_modules;
