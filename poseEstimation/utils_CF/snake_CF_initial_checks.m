...
% Some parts of the code are changed by Dong-hyung Kim, 16.08.25
...
HebiLookup;
g = HebiLookup.newConnectedGroupFromName('*','SA002');

numModules = g.getInfo.numModules;

accTrustability = ones(1,numModules);
accTrustability([9 12 16]) = 0;
gyrosTrustability = ones(1,numModules);
gyrosTrustability([8 11 12 15]) = 0;
